...
An intelligent Wiki overlay tool designed specifically for gamers, featuring automatic game detection for convenient wiki search and AI-powered RAG (Retrieval-Augmented Generation) capabilities for smart Q&A services.

Chinese README:👉 [中文说明请点击这里](README.zh-CN.md)
## 🎮 Key Features
